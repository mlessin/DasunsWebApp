...
export class SplistIsi extends Component {
  static propTypes = {
    ...
    return (
      <div>
        ...
        <div className="availHead">
          <h2>Available International Sign Language Interpreters</h2>
        </div>
...
export default connect(mapStateToProps, { getServiceProviders })(SplistIsi);
