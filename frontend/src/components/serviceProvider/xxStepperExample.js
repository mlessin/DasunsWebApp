...
render() {
  return (
    <MDBContainer>
      ...
      <Stepper>
        <Step label="give" stepName="Basic Information" onClick={this.swapFormActive(1)(1)}></Step>
        <Step icon="pencil-alt" stepName="Personal Data" onClick={this.swapFormActive(1)(2)}></Step>
