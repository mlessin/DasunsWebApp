  ...
  render() {
    ...
    return (
      <div>
        ...
        >
          <h1 class="display-6">All available Personal Support Assistants</h1>
          <p class="lead">
            Browse through the list of professional Personal Support Assistants and make your
            booking
          </p>
        </section>
        ...
        <div className="subavail">Only allowed to book one Personal Support Assistant</div>
                ...
                <div className="container">
                  <div className= "row">
                    ...
                    <img
                          ...
                          style={{ height: "50px" }}
                          onClick={() => history.push('/bookingForm/:id', {
