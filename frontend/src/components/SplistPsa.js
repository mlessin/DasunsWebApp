...
export class SplistPsa extends Component {
  static propTypes = {
  ...
  render() {
    ...
    return (
      <div>
        ...
        <section
          id="header"
          className="jumbotron text-center text-white img-responsive"
        >
          <h1 className="display-6">
            All available Personal Support Assistants
          </h1>
          <p className="lead">
            Browse through the list of professional Personal Support Assistants
            and make your booking
          </p>
        </section>
        <div className="availHead">
          <h2>Available Personal Support Assistants</h2>
        </div>
        <div className="subavail">
          Only allowed to book one Personal Support Assistant
        </div>
        <div className="ServiceP-list">
          {this.props.serviceProviders.map((serviceProvider) => (
            <div key={serviceProvider.id}>
              <div className="overallcontainer">
                {serviceProvider.service !== "Personal Support Assistance" ? (
                  <span style={{ display: "flex", justifyContent: "center" }}>
                    There are no Personal Support Assistants now, check again
                    later
                  </span>
                ) : (
                  <div className="container">
                    <div className="row">
                      ...
                      <div className="col-11">
                        ...
                        <p>
                          Service:
                          <strong> {`${serviceProvider.service}`}</strong>
                        </p>
                        <div
...
export default connect(mapStateToProps, { getServiceProviders })(SplistPsa);
