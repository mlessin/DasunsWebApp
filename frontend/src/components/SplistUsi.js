  ...
  render() {
    ...
    return (
      <div>
        ...
        >
          <h1 class="display-6">
            All available Ugandan Sign Language interpreters
          </h1>
          <p class="lead">
            Browse through the list of professional Ugandan Sign Language
              ...
              <div className="overallcontainer">
                ...
                "Ugandan Sign Language Interpreter" ? (
                  <span style={{ display: "flex", justifyContent: "center" }}>
                    There are no Ugandan Sign Language Interpreters now, check
                    again later
                  </span>
                ) : (
