...
export class SplistUsi extends Component {
  static propTypes = {
  ...
  render() {
    ...
    return (
      <div>
        ...
        >
          <h1 class="display-6">All available Ugandan Sign Language interpreters</h1>
          <p class="lead">
            Browse through the list of professional Ugandan Sign Language interpreters and make your
            booking
          </p>
        </section>
        <div className="availHead">
          <h2>Available Ugandan Sign Language Interpreters</h2>
        </div>
        ...
        <div className="ServiceP-list">
          {this.props.serviceProviders.map((serviceProvider) => (
            <div key={serviceProvider.id}>
              ...
              {serviceProvider.service === "Ugandan Sign Language Interpreter" ? (
...
export default connect(mapStateToProps, { getServiceProviders })(SplistUsi);
